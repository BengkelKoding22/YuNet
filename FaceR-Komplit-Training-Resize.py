...
import time  # Tambahkan ini di bagian atas skrip
...
parser.add_argument('--folder', '-f', type=str, default='./FotoBanyak2022', help='Folder path containing images to process.')
...
for filename in os.listdir(args.folder):
    ...
    # image = cv2.resize(image, (image.shape[1] // 32, image.shape[0] // 32))
